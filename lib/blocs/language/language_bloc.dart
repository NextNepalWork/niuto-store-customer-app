...
class LanguageBloc extends Bloc<LanguageEvent, LanguageState> {
  ...
  Stream<LanguageState> _mapLanguageLoadServerToState(
    ...
    if (selectedLangId == null) {
      final String selectedLangTitle = AppData.settingsResponse
          .getKeyValue(SettingsResponse.LANGUAGE_CODE)
          .toUpperCase()
          .trim();
      final int selectedLangId = int.parse(AppData.settingsResponse
          .getKeyValue(SettingsResponse.LANGUAGE_ID)
          .toString());
      final String selectedLangCode = AppData.settingsResponse
          .getKeyValue(SettingsResponse.LANGUAGE_CODE)
          .toLowerCase()
          .trim();
