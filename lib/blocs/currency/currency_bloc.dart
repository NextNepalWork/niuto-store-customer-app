...
class CurrencyBloc extends Bloc<CurrencyEvent, CurrencyState> {
  ...
  Stream<CurrencyState> _mapCurrencyLoadServerToState(
    ...
    if (selectedCurrencyTitle == null) {
      await sharedPrefService.setSelectedCurrencyTitle(AppData.settingsResponse
          .getKeyValue(SettingsResponse.CURRENCY_SYMBOL)
          .trim());
      await sharedPrefService.setSelectedCurrencyId(int.parse(AppData
          .settingsResponse
          .getKeyValue(SettingsResponse.CURRENCY_ID)
          .toString()));
      await sharedPrefService.setSelectedCurrencySymbol(AppData.settingsResponse
          .getKeyValue(SettingsResponse.CURRENCY_SYMBOL)
          .trim());
