...
class SharedPreferencesService {
  ...
  Future<void> setSelectedLangTitle(String langTitle) async =>
      await _preferences.setString(
          SharedPrefKeys.SELECTED_LANG_TITLE, langTitle);
  ...
  int get getSelectedProductId =>
      _preferences.getInt(SharedPrefKeys.PRODUCT_ID);
  ...
  Future<void> setSelectedCurrencyTitle(String currencyTitle) async =>
      await _preferences.setString(
          SharedPrefKeys.SELECTED_CURRENCY_TITLE, currencyTitle);

  String get selectedCurrencyTitle =>
      _preferences.getString(SharedPrefKeys.SELECTED_CURRENCY_TITLE);

  Future<void> setSelectedCurrencyId(int currencyId) async => await _preferences
      .setInt(SharedPrefKeys.SELECTED_CURRENCY_ID, currencyId);

  Future<void> setSelectedProductId(int productId) async =>
      await _preferences.setInt(SharedPrefKeys.PRODUCT_ID, productId);
  ...
  Future<void> setSelectedCurrencySymbol(String currencySymbol) async =>
      await _preferences.setString(
          SharedPrefKeys.SELECTED_CURRENCY_SYMBOL, currencySymbol);
