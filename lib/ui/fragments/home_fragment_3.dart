              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    HotItemsWidget(isTitleVisible: false, navigateToNext: widget.navigateToNext),
                    SaleBannerWidget(isTitleVisible: false, navigateToNext: widget.navigateToNext),
                    TopSellingProductsWidget(widget.navigateToNext),
                    NewArrivalsBannerWidget(isTitleVisible: true, navigateToNext: widget.navigateToNext),
